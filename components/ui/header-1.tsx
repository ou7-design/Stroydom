	...
	return (
		...
		>
			<nav className="mx-auto flex h-14 w-full max-w-5xl items-center justify-between px-4">
				<div className="hover:bg-accent rounded-md px-2 py-1 cursor-pointer">
					<AnimatedText
						text="STROYDOM"
						fontSize={20}
						minWeight={500}
...
function CartButton() {
	...
	return (
		<button
			...
			aria-label="Savatchani ko'rish"
		>
			<ShoppingBag className="w-5 h-5" />
			{totalCount > 0 && (
				<span className="absolute -top-1 -right-1 min-w-[18px] h-[18px] bg-primary text-primary-foreground text-[10px] font-bold rounded-full flex items-center justify-center px-1 shadow-sm">
